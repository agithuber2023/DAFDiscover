...
def pre_process():
    with open('data/raisin/raisin-enhanced-10-10000-dirty.csv', 'r', encoding='utf-8-sig') as csv_file:
    ...
    with open('data/raisin/raisin-enhanced-10-10000.csv', 'r', encoding='utf-8-sig') as csv_file:
        csv_reader=csv.reader(csv_file)
        csv_data=[row for row in csv_reader]
