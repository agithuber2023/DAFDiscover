...
if __name__ == "__main__":
    ...
    # error_list=[0,0,0,0,0.002,0,0.005] #chess
    #error_list=[0,0,0,0,0.001,0,0,0.003,0,0,0,0,0.001] #forestfires
    #error_list=[0,0,0,0,0.001,0,0,0.003,0,0,0,0,0.001,0,0] #adult
    # error_list=[0,0,0,0,0.001,0,0,0.003,0] #abalone
    #error_list=[0,0,0,0,0.006,0,0.007,0.001] #raisin
    error_list=[0.01,0.01,0.01,0.01,0.01,0.01,0.01,0.01,0.01,0.01,0.01, 0.01, 0.01, 0.01, 0.01]
    ntane = DAFDiscover(T)
